...
declare const SealedSymbol: unique symbol;
 ...
 */
export declare const seal: <E extends DomainEvent>(event: E) => Sealed<E>;
/** Unwrap a sealed event back to its raw `DomainEvent`. */
export declare const unseal: <E extends DomainEvent>(sealed: Sealed<E>) => E;
export {};
