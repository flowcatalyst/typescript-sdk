 ...
 */
export declare const postApiAdminPrincipalsByIdSendPasswordReset: <ThrowOnError extends boolean = false>(options: Options<PostApiAdminPrincipalsByIdSendPasswordResetData, ThrowOnError>) => import("./client").RequestResult<PostApiAdminPrincipalsByIdSendPasswordResetResponses, PostApiAdminPrincipalsByIdSendPasswordResetErrors, ThrowOnError, "fields">;
/**
 * List roles
 */
 ...
 * no pagination — see `DispatchJobsQuery` for the rationale.
 */
export declare const getApiAdminDispatchJobs2: <ThrowOnError extends boolean = false>(options?: Options<GetApiAdminDispatchJobs2Data, ThrowOnError>) => import("./client").RequestResult<GetApiAdminDispatchJobs2Responses, unknown, ThrowOnError, "fields">;
/**
 * Create a new dispatch job
 *
 * Creates and queues a new dispatch job for webhook delivery.
 */
export declare const postApiAdminDispatchJobs2: <ThrowOnError extends boolean = false>(options: Options<PostApiAdminDispatchJobs2Data, ThrowOnError>) => import("./client").RequestResult<PostApiAdminDispatchJobs2Responses, PostApiAdminDispatchJobs2Errors, ThrowOnError, "fields">;
/**
 ...
 * Get dispatch jobs for an event
 */
export declare const getApiAdminDispatchJobsByEventByEventId2: <ThrowOnError extends boolean = false>(options: Options<GetApiAdminDispatchJobsByEventByEventId2Data, ThrowOnError>) => import("./client").RequestResult<GetApiAdminDispatchJobsByEventByEventId2Responses, unknown, ThrowOnError, "fields">;
/**
 * Get filter options for dispatch jobs
 *
 * Returns distinct values from the read projection for cascading filter dropdowns.
 ...
 * at high rates and page navigation is meaningless.
 */
export declare const getApiAdminDispatchJobsRaw2: <ThrowOnError extends boolean = false>(options?: Options<GetApiAdminDispatchJobsRaw2Data, ThrowOnError>) => import("./client").RequestResult<GetApiAdminDispatchJobsRaw2Responses, unknown, ThrowOnError, "fields">;
/**
 * Get dispatch job by ID
 */
export declare const getApiAdminDispatchJobsById2: <ThrowOnError extends boolean = false>(options: Options<GetApiAdminDispatchJobsById2Data, ThrowOnError>) => import("./client").RequestResult<GetApiAdminDispatchJobsById2Responses, GetApiAdminDispatchJobsById2Errors, ThrowOnError, "fields">;
/**
 * Get all attempts for a dispatch job
 *
 * Retrieves the full history of webhook delivery attempts for a job.
 */
export declare const getApiAdminDispatchJobsByIdAttempts2: <ThrowOnError extends boolean = false>(options: Options<GetApiAdminDispatchJobsByIdAttempts2Data, ThrowOnError>) => import("./client").RequestResult<GetApiAdminDispatchJobsByIdAttempts2Responses, GetApiAdminDispatchJobsByIdAttempts2Errors, ThrowOnError, "fields">;
/**
 * Get raw dispatch job data by ID
 *
 * Returns the full DispatchJob entity serialized directly as JSON (not the DTO).
 */
export declare const getApiAdminDispatchJobsByIdRaw2: <ThrowOnError extends boolean = false>(options: Options<GetApiAdminDispatchJobsByIdRaw2Data, ThrowOnError>) => import("./client").RequestResult<GetApiAdminDispatchJobsByIdRaw2Responses, GetApiAdminDispatchJobsByIdRaw2Errors, ThrowOnError, "fields">;
/**
 * List events. Returns the most recent rows matching the filters; no
 * pagination — see `EventsQuery` for the rationale.
 */
export declare const getApiAdminEvents2: <ThrowOnError extends boolean = false>(options?: Options<GetApiAdminEvents2Data, ThrowOnError>) => import("./client").RequestResult<GetApiAdminEvents2Responses, unknown, ThrowOnError, "fields">;
/**
 * Create a new event
 *
 * Creates a new event in the event store. If a deduplicationId is provided and
 ...
 * Dispatch jobs are automatically created for matching subscriptions.
 */
export declare const postApiAdminEvents2: <ThrowOnError extends boolean = false>(options: Options<PostApiAdminEvents2Data, ThrowOnError>) => import("./client").RequestResult<PostApiAdminEvents2Responses, PostApiAdminEvents2Errors, ThrowOnError, "fields">;
/**
 * Batch create events
 *
 ...
 * Get filter options for the events read model.
 */
export declare const getApiAdminEventsFilterOptions2: <ThrowOnError extends boolean = false>(options?: Options<GetApiAdminEventsFilterOptions2Data, ThrowOnError>) => import("./client").RequestResult<GetApiAdminEventsFilterOptions2Responses, unknown, ThrowOnError, "fields">;
/**
 * List raw events (from msg_events, not the read projection). Returns the
 * most recent rows; no pagination — msg_events ingests at high rates and
 * page navigation through the firehose is meaningless.
 */
export declare const getApiAdminEventsRaw2: <ThrowOnError extends boolean = false>(options?: Options<GetApiAdminEventsRaw2Data, ThrowOnError>) => import("./client").RequestResult<GetApiAdminEventsRaw2Responses, unknown, ThrowOnError, "fields">;
/**
 * Get event by ID
 */
export declare const getApiAdminEventsById2: <ThrowOnError extends boolean = false>(options: Options<GetApiAdminEventsById2Data, ThrowOnError>) => import("./client").RequestResult<GetApiAdminEventsById2Responses, GetApiAdminEventsById2Errors, ThrowOnError, "fields">;
/**
 ...
 */
export declare const getApiAdminFilterOptionsDispatchJobs: <ThrowOnError extends boolean = false>(options?: Options<GetApiAdminFilterOptionsDispatchJobsData, ThrowOnError>) => import("./client").RequestResult<GetApiAdminFilterOptionsDispatchJobsResponses, unknown, ThrowOnError, "fields">;
/**
 ...
 */
export declare const getApiAdminEventsFilterOptions3: <ThrowOnError extends boolean = false>(options?: Options<GetApiAdminEventsFilterOptions3Data, ThrowOnError>) => import("./client").RequestResult<GetApiAdminEventsFilterOptions3Responses, unknown, ThrowOnError, "fields">;
/**
