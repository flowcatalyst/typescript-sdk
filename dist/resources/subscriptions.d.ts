...
import type { GetApiSubscriptionsResponse, GetApiSubscriptionsByIdResponse, PostApiSubscriptionsData, PutApiSubscriptionsByIdData, PostApiApplicationsByAppCodeSubscriptionsSyncData, PostApiApplicationsByAppCodeSubscriptionsSyncResponse } from "../generated/types.gen.js";
...
export type UpdateSubscriptionRequest = PutApiSubscriptionsByIdData["body"];
export type SyncSubscriptionsResponse = PostApiApplicationsByAppCodeSubscriptionsSyncResponse;
...
export declare class SubscriptionsResource {
     ...
     */
    sync(applicationCode: string, subscriptions: PostApiApplicationsByAppCodeSubscriptionsSyncData["body"]["subscriptions"], removeUnlisted?: boolean): ResultAsync<SyncSubscriptionsResponse, SdkError>;
}
