...
import type { ListEventTypesResponse, GetEventTypeResponse, CreateEventTypeData, UpdateEventTypeData, AddEventTypeSchemaData, SyncEventTypesData, SyncEventTypesResponse as SyncEventTypesResponseType } from "../generated/types.gen.js";
...
export declare class EventTypesResource {
     ...
     */
    addSchemaVersion(id: string, schema: AddEventTypeSchemaData["body"]): ResultAsync<EventTypeResponse, SdkError>;
    /**
     ...
     */
    sync(applicationCode: string, eventTypes: SyncEventTypesData["body"]["eventTypes"], removeUnlisted?: boolean): ResultAsync<SyncEventTypesResponse, SdkError>;
}
