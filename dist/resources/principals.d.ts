...
import type { ListPrincipalsData, ListPrincipalsResponse, GetPrincipalResponse, CreateUserData, UpdatePrincipalData, ResetPrincipalPasswordData, ListPrincipalRolesResponse, ListPrincipalClientAccessResponse, SyncPrincipalsData, SyncPrincipalsResponse as SyncPrincipalsResponseType, SyncUsersData, SyncUsersResponse as SyncUsersResponseType } from "../generated/types.gen.js";
...
export declare class PrincipalsResource {
     ...
     */
    sync(applicationCode: string, principals: SyncPrincipalsData["body"]["principals"], removeUnlisted?: boolean): ResultAsync<SyncPrincipalsResponse, SdkError>;
    /**
     ...
     */
    syncUsers(principals: SyncUsersData["body"]["principals"]): ResultAsync<SyncUsersResponse, SdkError>;
}
