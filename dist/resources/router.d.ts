...
export declare class RouterResource {
     ...
     */
    isInPipeline(messageId: string): ResultAsync<InPipelineCheckResponse, SdkError>;
    /**
     ...
     */
    areInPipeline(messageIds: readonly string[]): ResultAsync<InPipelineBatchResponse, SdkError>;
}
