...
export interface Operation<TCommand extends Command, TEvent extends DomainEvent> {
     ...
     */
    authorize(command: TCommand, context: ExecutionContext): UseCaseError | null | undefined;
    /**
     ...
     */
    execute(command: TCommand, context: ExecutionContext): Promise<Plan<TEvent> | UseCaseError>;
}
/**
 ...
 */
export declare function publicAuthorize(): null;
/**
 ...
 */
export declare function run<TCommand extends Command, TEvent extends DomainEvent>(uow: TxRunner, op: Operation<TCommand, TEvent>, command: TCommand, context: ExecutionContext): Promise<Result<TEvent>>;
