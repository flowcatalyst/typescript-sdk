...
export class PgSessionStore {
    ...
    async write(reply, session) {
        ...
        await this.executor.query(`INSERT INTO ${this.table} (sid, payload, expires_at) VALUES ($1, $2, $3)
			 ON CONFLICT (sid) DO UPDATE SET payload = EXCLUDED.payload, expires_at = EXCLUDED.expires_at`, [sid, payload, expiresAt]);
